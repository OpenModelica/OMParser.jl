...
#endif
#define NFExpression__SUBSCRIPTED_5fEXP_3dBOX4 28
#define NFExpression__SUBSCRIPTED_5fEXP(exp,subscripts,ty,split) (mmc_mk_box5(28,&NFExpression_NFExpression_SUBSCRIPTED__EXP__desc,exp,subscripts,ty,split))
#ifdef ADD_METARECORD_DEFINITIONS
