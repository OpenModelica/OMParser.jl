...
assert((Absyn_Operator_ADD_EW_type = jl_get_global(Absyn, jl_symbol("ADD_EW"))));
...
assert((Absyn_Algorithm_ALG_ASSIGN_type = jl_get_global(Absyn, jl_symbol("ALG_ASSIGN"))));
assert((Absyn_Algorithm_ALG_BREAK = jl_get_function(Absyn, "ALG_BREAK")));
assert((Absyn_Algorithm_ALG_BREAK_type = jl_get_global(Absyn, jl_symbol("ALG_BREAK"))));
assert((Absyn_Algorithm_ALG_CONTINUE = jl_get_function(Absyn, "ALG_CONTINUE")));
assert((Absyn_Algorithm_ALG_CONTINUE_type = jl_get_global(Absyn, jl_symbol("ALG_CONTINUE"))));
assert((Absyn_Algorithm_ALG_FAILURE = jl_get_function(Absyn, "ALG_FAILURE")));
assert((Absyn_Algorithm_ALG_FAILURE_type = jl_get_global(Absyn, jl_symbol("ALG_FAILURE"))));
assert((Absyn_Algorithm_ALG_FOR = jl_get_function(Absyn, "ALG_FOR")));
assert((Absyn_Algorithm_ALG_FOR_type = jl_get_global(Absyn, jl_symbol("ALG_FOR"))));
assert((Absyn_Algorithm_ALG_IF = jl_get_function(Absyn, "ALG_IF")));
assert((Absyn_Algorithm_ALG_IF_type = jl_get_global(Absyn, jl_symbol("ALG_IF"))));
assert((Absyn_Algorithm_ALG_NORETCALL = jl_get_function(Absyn, "ALG_NORETCALL")));
assert((Absyn_Algorithm_ALG_NORETCALL_type = jl_get_global(Absyn, jl_symbol("ALG_NORETCALL"))));
assert((Absyn_Algorithm_ALG_PARFOR = jl_get_function(Absyn, "ALG_PARFOR")));
assert((Absyn_Algorithm_ALG_PARFOR_type = jl_get_global(Absyn, jl_symbol("ALG_PARFOR"))));
assert((Absyn_Algorithm_ALG_RETURN = jl_get_function(Absyn, "ALG_RETURN")));
assert((Absyn_Algorithm_ALG_RETURN_type = jl_get_global(Absyn, jl_symbol("ALG_RETURN"))));
assert((Absyn_Algorithm_ALG_TRY = jl_get_function(Absyn, "ALG_TRY")));
assert((Absyn_Algorithm_ALG_TRY_type = jl_get_global(Absyn, jl_symbol("ALG_TRY"))));
assert((Absyn_Algorithm_ALG_WHEN_A = jl_get_function(Absyn, "ALG_WHEN_A")));
assert((Absyn_Algorithm_ALG_WHEN_A_type = jl_get_global(Absyn, jl_symbol("ALG_WHEN_A"))));
assert((Absyn_Algorithm_ALG_WHILE = jl_get_function(Absyn, "ALG_WHILE")));
assert((Absyn_Algorithm_ALG_WHILE_type = jl_get_global(Absyn, jl_symbol("ALG_WHILE"))));
...
assert((Absyn_ClassDef_CLASS_EXTENDS_type = jl_get_global(Absyn, jl_symbol("CLASS_EXTENDS"))));
...
assert((Absyn_ComponentRef_CREF_FULLYQUALIFIED_type = jl_get_global(Absyn, jl_symbol("CREF_FULLYQUALIFIED"))));
assert((Absyn_ComponentRef_CREF_IDENT = jl_get_function(Absyn, "CREF_IDENT")));
assert((Absyn_ComponentRef_CREF_IDENT_type = jl_get_global(Absyn, jl_symbol("CREF_IDENT"))));
assert((Absyn_ComponentRef_CREF_QUAL = jl_get_function(Absyn, "CREF_QUAL")));
assert((Absyn_ComponentRef_CREF_QUAL_type = jl_get_global(Absyn, jl_symbol("CREF_QUAL"))));
assert((Absyn_CodeNode_C_ALGORITHMSECTION = jl_get_function(Absyn, "C_ALGORITHMSECTION")));
assert((Absyn_CodeNode_C_ALGORITHMSECTION_type = jl_get_global(Absyn, jl_symbol("C_ALGORITHMSECTION"))));
assert((Absyn_CodeNode_C_CONSTRAINTSECTION = jl_get_function(Absyn, "C_CONSTRAINTSECTION")));
assert((Absyn_CodeNode_C_CONSTRAINTSECTION_type = jl_get_global(Absyn, jl_symbol("C_CONSTRAINTSECTION"))));
assert((Absyn_CodeNode_C_ELEMENT = jl_get_function(Absyn, "C_ELEMENT")));
assert((Absyn_CodeNode_C_ELEMENT_type = jl_get_global(Absyn, jl_symbol("C_ELEMENT"))));
assert((Absyn_CodeNode_C_EQUATIONSECTION = jl_get_function(Absyn, "C_EQUATIONSECTION")));
assert((Absyn_CodeNode_C_EQUATIONSECTION_type = jl_get_global(Absyn, jl_symbol("C_EQUATIONSECTION"))));
assert((Absyn_CodeNode_C_EXPRESSION = jl_get_function(Absyn, "C_EXPRESSION")));
assert((Absyn_CodeNode_C_EXPRESSION_type = jl_get_global(Absyn, jl_symbol("C_EXPRESSION"))));
assert((Absyn_CodeNode_C_MODIFICATION = jl_get_function(Absyn, "C_MODIFICATION")));
assert((Absyn_CodeNode_C_MODIFICATION_type = jl_get_global(Absyn, jl_symbol("C_MODIFICATION"))));
assert((Absyn_CodeNode_C_TYPENAME = jl_get_function(Absyn, "C_TYPENAME")));
assert((Absyn_CodeNode_C_TYPENAME_type = jl_get_global(Absyn, jl_symbol("C_TYPENAME"))));
assert((Absyn_CodeNode_C_VARIABLENAME = jl_get_function(Absyn, "C_VARIABLENAME")));
assert((Absyn_CodeNode_C_VARIABLENAME_type = jl_get_global(Absyn, jl_symbol("C_VARIABLENAME"))));
...
assert((Absyn_Operator_DIV_EW_type = jl_get_global(Absyn, jl_symbol("DIV_EW"))));
...
assert((Absyn_EnumDef_ENUM_COLON_type = jl_get_global(Absyn, jl_symbol("ENUM_COLON"))));
...
assert((Absyn_Equation_EQ_CONNECT_type = jl_get_global(Absyn, jl_symbol("EQ_CONNECT"))));
assert((Absyn_Equation_EQ_EQUALS = jl_get_function(Absyn, "EQ_EQUALS")));
assert((Absyn_Equation_EQ_EQUALS_type = jl_get_global(Absyn, jl_symbol("EQ_EQUALS"))));
assert((Absyn_Equation_EQ_FAILURE = jl_get_function(Absyn, "EQ_FAILURE")));
assert((Absyn_Equation_EQ_FAILURE_type = jl_get_global(Absyn, jl_symbol("EQ_FAILURE"))));
assert((Absyn_Equation_EQ_FOR = jl_get_function(Absyn, "EQ_FOR")));
assert((Absyn_Equation_EQ_FOR_type = jl_get_global(Absyn, jl_symbol("EQ_FOR"))));
assert((Absyn_Equation_EQ_IF = jl_get_function(Absyn, "EQ_IF")));
assert((Absyn_Equation_EQ_IF_type = jl_get_global(Absyn, jl_symbol("EQ_IF"))));
assert((Absyn_Equation_EQ_NORETCALL = jl_get_function(Absyn, "EQ_NORETCALL")));
assert((Absyn_Equation_EQ_NORETCALL_type = jl_get_global(Absyn, jl_symbol("EQ_NORETCALL"))));
assert((Absyn_Equation_EQ_PDE = jl_get_function(Absyn, "EQ_PDE")));
assert((Absyn_Equation_EQ_PDE_type = jl_get_global(Absyn, jl_symbol("EQ_PDE"))));
assert((Absyn_Equation_EQ_WHEN_E = jl_get_function(Absyn, "EQ_WHEN_E")));
assert((Absyn_Equation_EQ_WHEN_E_type = jl_get_global(Absyn, jl_symbol("EQ_WHEN_E"))));
...
assert((Absyn_FunctionArgs_FOR_ITER_FARG_type = jl_get_global(Absyn, jl_symbol("FOR_ITER_FARG"))));
assert((Absyn_FunctionRestriction_FR_KERNEL_FUNCTION = jl_get_function(Absyn, "FR_KERNEL_FUNCTION")));
assert((Absyn_FunctionRestriction_FR_KERNEL_FUNCTION_type = jl_get_global(Absyn, jl_symbol("FR_KERNEL_FUNCTION"))));
assert((Absyn_FunctionRestriction_FR_NORMAL_FUNCTION = jl_get_function(Absyn, "FR_NORMAL_FUNCTION")));
assert((Absyn_FunctionRestriction_FR_NORMAL_FUNCTION_type = jl_get_global(Absyn, jl_symbol("FR_NORMAL_FUNCTION"))));
assert((Absyn_FunctionRestriction_FR_OPERATOR_FUNCTION = jl_get_function(Absyn, "FR_OPERATOR_FUNCTION")));
assert((Absyn_FunctionRestriction_FR_OPERATOR_FUNCTION_type = jl_get_global(Absyn, jl_symbol("FR_OPERATOR_FUNCTION"))));
assert((Absyn_FunctionRestriction_FR_PARALLEL_FUNCTION = jl_get_function(Absyn, "FR_PARALLEL_FUNCTION")));
assert((Absyn_FunctionRestriction_FR_PARALLEL_FUNCTION_type = jl_get_global(Absyn, jl_symbol("FR_PARALLEL_FUNCTION"))));
...
assert((Absyn_Import_GROUP_IMPORT_type = jl_get_global(Absyn, jl_symbol("GROUP_IMPORT"))));
assert((Absyn_GroupImport_GROUP_IMPORT_NAME = jl_get_function(Absyn, "GROUP_IMPORT_NAME")));
assert((Absyn_GroupImport_GROUP_IMPORT_NAME_type = jl_get_global(Absyn, jl_symbol("GROUP_IMPORT_NAME"))));
assert((Absyn_GroupImport_GROUP_IMPORT_RENAME = jl_get_function(Absyn, "GROUP_IMPORT_RENAME")));
assert((Absyn_GroupImport_GROUP_IMPORT_RENAME_type = jl_get_global(Absyn, jl_symbol("GROUP_IMPORT_RENAME"))));
...
assert((Absyn_InnerOuter_INNER_OUTER_type = jl_get_global(Absyn, jl_symbol("INNER_OUTER"))));
...
assert((Absyn_Direction_INPUT_OUTPUT_type = jl_get_global(Absyn, jl_symbol("INPUT_OUTPUT"))));
...
assert((Absyn_ElementItem_LEXER_COMMENT_type = jl_get_global(Absyn, jl_symbol("LEXER_COMMENT"))));
...
assert((Absyn_Operator_MUL_EW_type = jl_get_global(Absyn, jl_symbol("MUL_EW"))));
...
assert((Absyn_Import_NAMED_IMPORT_type = jl_get_global(Absyn, jl_symbol("NAMED_IMPORT"))));
...
assert((Absyn_Each_NON_EACH_type = jl_get_global(Absyn, jl_symbol("NON_EACH"))));
assert((Absyn_Parallelism_NON_PARALLEL = jl_get_function(Absyn, "NON_PARALLEL")));
assert((Absyn_Parallelism_NON_PARALLEL_type = jl_get_global(Absyn, jl_symbol("NON_PARALLEL"))));
...
assert((Absyn_FlowStream_NOT_FLOW_STREAM_type = jl_get_global(Absyn, jl_symbol("NOT_FLOW_STREAM"))));
assert((Absyn_InnerOuter_NOT_INNER_OUTER = jl_get_function(Absyn, "NOT_INNER_OUTER")));
assert((Absyn_InnerOuter_NOT_INNER_OUTER_type = jl_get_global(Absyn, jl_symbol("NOT_INNER_OUTER"))));
assert((Absyn_Msg_NO_MSG = jl_get_function(Absyn, "NO_MSG")));
assert((Absyn_Msg_NO_MSG_type = jl_get_global(Absyn, jl_symbol("NO_MSG"))));
assert((Absyn_FunctionPurity_NO_PURITY = jl_get_function(Absyn, "NO_PURITY")));
assert((Absyn_FunctionPurity_NO_PURITY_type = jl_get_global(Absyn, jl_symbol("NO_PURITY"))));
...
assert((Absyn_Operator_POW_EW_type = jl_get_global(Absyn, jl_symbol("POW_EW"))));
...
assert((Absyn_Import_QUAL_IMPORT_type = jl_get_global(Absyn, jl_symbol("QUAL_IMPORT"))));
...
assert((Absyn_RedeclareKeywords_REDECLARE_REPLACEABLE_type = jl_get_global(Absyn, jl_symbol("REDECLARE_REPLACEABLE"))));
...
assert((Absyn_Restriction_R_BLOCK_type = jl_get_global(Absyn, jl_symbol("R_BLOCK"))));
assert((Absyn_Restriction_R_CLASS = jl_get_function(Absyn, "R_CLASS")));
assert((Absyn_Restriction_R_CLASS_type = jl_get_global(Absyn, jl_symbol("R_CLASS"))));
assert((Absyn_Restriction_R_CONNECTOR = jl_get_function(Absyn, "R_CONNECTOR")));
assert((Absyn_Restriction_R_CONNECTOR_type = jl_get_global(Absyn, jl_symbol("R_CONNECTOR"))));
assert((Absyn_Restriction_R_ENUMERATION = jl_get_function(Absyn, "R_ENUMERATION")));
assert((Absyn_Restriction_R_ENUMERATION_type = jl_get_global(Absyn, jl_symbol("R_ENUMERATION"))));
assert((Absyn_Restriction_R_EXP_CONNECTOR = jl_get_function(Absyn, "R_EXP_CONNECTOR")));
assert((Absyn_Restriction_R_EXP_CONNECTOR_type = jl_get_global(Absyn, jl_symbol("R_EXP_CONNECTOR"))));
assert((Absyn_Restriction_R_FUNCTION = jl_get_function(Absyn, "R_FUNCTION")));
assert((Absyn_Restriction_R_FUNCTION_type = jl_get_global(Absyn, jl_symbol("R_FUNCTION"))));
assert((Absyn_Restriction_R_METARECORD = jl_get_function(Absyn, "R_METARECORD")));
assert((Absyn_Restriction_R_METARECORD_type = jl_get_global(Absyn, jl_symbol("R_METARECORD"))));
assert((Absyn_Restriction_R_MODEL = jl_get_function(Absyn, "R_MODEL")));
assert((Absyn_Restriction_R_MODEL_type = jl_get_global(Absyn, jl_symbol("R_MODEL"))));
assert((Absyn_Restriction_R_OPERATOR = jl_get_function(Absyn, "R_OPERATOR")));
assert((Absyn_Restriction_R_OPERATOR_type = jl_get_global(Absyn, jl_symbol("R_OPERATOR"))));
assert((Absyn_Restriction_R_OPERATOR_RECORD = jl_get_function(Absyn, "R_OPERATOR_RECORD")));
assert((Absyn_Restriction_R_OPERATOR_RECORD_type = jl_get_global(Absyn, jl_symbol("R_OPERATOR_RECORD"))));
assert((Absyn_Restriction_R_OPTIMIZATION = jl_get_function(Absyn, "R_OPTIMIZATION")));
assert((Absyn_Restriction_R_OPTIMIZATION_type = jl_get_global(Absyn, jl_symbol("R_OPTIMIZATION"))));
assert((Absyn_Restriction_R_PACKAGE = jl_get_function(Absyn, "R_PACKAGE")));
assert((Absyn_Restriction_R_PACKAGE_type = jl_get_global(Absyn, jl_symbol("R_PACKAGE"))));
assert((Absyn_Restriction_R_PREDEFINED_BOOLEAN = jl_get_function(Absyn, "R_PREDEFINED_BOOLEAN")));
assert((Absyn_Restriction_R_PREDEFINED_BOOLEAN_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_BOOLEAN"))));
assert((Absyn_Restriction_R_PREDEFINED_CLOCK = jl_get_function(Absyn, "R_PREDEFINED_CLOCK")));
assert((Absyn_Restriction_R_PREDEFINED_CLOCK_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_CLOCK"))));
assert((Absyn_Restriction_R_PREDEFINED_ENUMERATION = jl_get_function(Absyn, "R_PREDEFINED_ENUMERATION")));
assert((Absyn_Restriction_R_PREDEFINED_ENUMERATION_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_ENUMERATION"))));
assert((Absyn_Restriction_R_PREDEFINED_INTEGER = jl_get_function(Absyn, "R_PREDEFINED_INTEGER")));
assert((Absyn_Restriction_R_PREDEFINED_INTEGER_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_INTEGER"))));
assert((Absyn_Restriction_R_PREDEFINED_REAL = jl_get_function(Absyn, "R_PREDEFINED_REAL")));
assert((Absyn_Restriction_R_PREDEFINED_REAL_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_REAL"))));
assert((Absyn_Restriction_R_PREDEFINED_STRING = jl_get_function(Absyn, "R_PREDEFINED_STRING")));
assert((Absyn_Restriction_R_PREDEFINED_STRING_type = jl_get_global(Absyn, jl_symbol("R_PREDEFINED_STRING"))));
assert((Absyn_Restriction_R_RECORD = jl_get_function(Absyn, "R_RECORD")));
assert((Absyn_Restriction_R_RECORD_type = jl_get_global(Absyn, jl_symbol("R_RECORD"))));
assert((Absyn_Restriction_R_TYPE = jl_get_function(Absyn, "R_TYPE")));
assert((Absyn_Restriction_R_TYPE_type = jl_get_global(Absyn, jl_symbol("R_TYPE"))));
assert((Absyn_Restriction_R_UNIONTYPE = jl_get_function(Absyn, "R_UNIONTYPE")));
assert((Absyn_Restriction_R_UNIONTYPE_type = jl_get_global(Absyn, jl_symbol("R_UNIONTYPE"))));
assert((Absyn_Restriction_R_UNKNOWN = jl_get_function(Absyn, "R_UNKNOWN")));
assert((Absyn_Restriction_R_UNKNOWN_type = jl_get_global(Absyn, jl_symbol("R_UNKNOWN"))));
...
assert((Absyn_Operator_SUB_EW_type = jl_get_global(Absyn, jl_symbol("SUB_EW"))));
...
assert((Absyn_Operator_UMINUS_EW_type = jl_get_global(Absyn, jl_symbol("UMINUS_EW"))));
...
assert((Absyn_Import_UNQUAL_IMPORT_type = jl_get_global(Absyn, jl_symbol("UNQUAL_IMPORT"))));
...
assert((Absyn_Operator_UPLUS_EW_type = jl_get_global(Absyn, jl_symbol("UPLUS_EW"))));
